...
stopwords = ['i', 'me', 'my', 'myself', 'we', 'our', 'ours', 'ourselves', 'you', 'your', 'yours',
			 ...
			 'just', 'don', 'should', 'now', 'let', 'go', 'none']
#stopwords = stopwords.words('english')
#stopwords = [line.strip() for line in open('/Users/dmeyer3691/Development/RubyOnRails/youdou/app/controllers/stopwords.txt', 'r').readlines()]
